...
var TaskService = /** @class */ (function () {
    ...
    TaskService.prototype.getTasks = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.taskRepository.getTasks()];
    ...
    TaskService.prototype.createTask = function (task) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.taskRepository.createTask(task)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    TaskService.prototype.updateTask = function (task) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.taskRepository.updateTask(task)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
